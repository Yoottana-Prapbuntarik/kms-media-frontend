...
export const profileReducer = (
  state: ProfilePresenter = profilePresenter,
  action: any
) => {
  switch (action.type) {
...
const mapDispatchToProps = (dispatch: Dispatch, ownProps) => ({
  getUserProfile: async () => {
    await dispatch(
      getUserProfile(ownProps.firstName, ownProps.lastName, ownProps.uuid)
    ),
  ...
  handleUpdateProfile: (information: any, image: string) => {
      dispatch(
        updateUserProfile(
